<div align="center">
  <h1><img src="https://slackmojis.com/emojis/13387-gokurun/download" width="35"> <code>System.out.println("Hello, I'm Chirag!");</code></h1>

  <a href="https://github.com/chirag640">
    <img src="https://readme-typing-svg.herokuapp.com/?font=Fira+Code&weight=600&size=22&pause=1000&color=00FFCC&center=true&vCenter=true&width=500&lines=Full-Stack+Developer;Flutter+%2B+NestJS+Specialist;Building+Scalable+Architectures;Turning+Coffee+Into+Code" alt="Typing SVG" />
  </a>
  <br><br>
...
## <img src="https://slackmojis.com/emojis/10254-pepe_naruto/download" width="30"> **`Developer_Profile.json`**

```json
{
  "developer": "Chirag Chaudhary",
  "class": "Full-Stack Ninja",
  "weapons_of_choice": ["Flutter", "Next.js", "NestJS", "Node.js"],
  "current_quests": [
    "Developing a Flutter Blueprint CLI tool 🛠️",
    "Building an Ethiopian number plate scanner module 🚘",
    "Creating a NestJS backend automation tool ⚡"
  ],
  "skill_tree_upgrades": [
  ...
  "side_missions": [
    "Gearing up for the Smart India Hackathon (SIH) 💻",
    "Navigating the Indian personal finance and investing market 📈",
    "Building real-world problem solvers like a Splitwise clone and Truck Expense app 🚀"
  ]
}
```
<h2><img src="https://slackmojis.com/emojis/76421-anime_itachiakatsuki/download" width="30" /> <b>My Arsenal (Tech Stack)</b></h2>
